...
FROM
	film
WHERE 
	title IN ('The Godfather', 'The Shawshank Redemption', 'Meet Joe Black')
...
VALUES 
	('2017-02-14 13:45:21.914+01', 4582, 87, 2, current_date),
...
VALUES 
	(87, 2, 32296, 4.99, '2017-02-14 13:45:21.914+01', current_date),
